...
emm_resp_e_coli_2=emmeans(mm_resp_e_coli_2, specs=pairwise ~ N_dose)
...
emm_resp_no_e_coli_2=emmeans(mm_resp_no_e_coli_2, specs=pairwise ~ sym_state)
...
#1
gg_resp_all_ecoli<-
  ggplot(e_coli, aes(x=treat_ID_full, y=resp_rate, color=temp)) +
...
gg_food_sym_state_ecoli<-
  ggplot(e_coli, aes(x=food_sym_state, y=resp_rate, color=temp)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+
...
gg_resp_all_no_ecoli<-
  ggplot(no_e_coli, aes(x=treat_ID, y=resp_rate, color=temp)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+
...
gg_food_sym_state_no_ecoli<-
  ggplot(no_e_coli, aes(x=food_sym_state, y=resp_rate, color=temp)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+
...
gg_N_species_dose_ecoli<-
  ggplot(e_coli, aes(x=N_species_dose, y=resp_rate, color=temp)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+
...
gg_N_species_dose_no_ecoli<-
  ggplot(no_e_coli, aes(x=N_species_dose, y=resp_rate, color=temp)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+
...
gg_temp_no_ecoli<-
  ggplot(no_e_coli, aes(x=temp, y=resp_rate)) +
  geom_boxplot(width=0.8) +
  geom_jitter(width=0.15, alpha=0.9) +
 # geom_line(aes(group=e_coli_plate), col="darkgray")+
  ylab("Respirometry rate")+

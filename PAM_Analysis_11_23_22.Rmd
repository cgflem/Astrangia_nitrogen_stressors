---
title: "PAM data: last updated 12/8/22 C. Fleming"
...
t.test(all_fed$ordernorm_PAM_delta,all_starved$ordernorm_PAM_delta) #  p-value = 0.9898
#Comparing PAM_delta for sym fed v. sym starved
t.test(all_sym_fed$ordernorm_PAM_delta,all_sym_starved$ordernorm_PAM_delta) #p-value = 0.2208
#Comparing PAM_delta for apo fed v. apo starved
t.test(all_apo_fed$ordernorm_PAM_delta,all_apo_starved$ordernorm_PAM_delta) #p-value = 0.06325
mean(all_apo_fed$ordernorm_PAM_delta) #avg = 0.1515622
mean(all_apo_starved$ordernorm_PAM_delta) #avg = 0.2987816 #starved colonies had a greater change in photosynthetic efficiency
#Comparing PAM_delta between sym fed vs. apo fed #this is okay to do because delta should capture the changes
t.test(all_apo_fed$ordernorm_PAM_delta,all_sym_fed$ordernorm_PAM_delta) #p-value = 0.0009132
mean(all_apo_fed$ordernorm_PAM_delta) #avg = 0.1515622
mean(all_sym_fed$ordernorm_PAM_delta) #avg = -0.1617836 #symbiotic colonies lost more photosynthetic efficiency
#Comparing PAM_delta between sym starved vs. apo starved #this is okay to do because delta should capture the changes
t.test(all_apo_starved$ordernorm_PAM_delta,all_sym_starved$ordernorm_PAM_delta) #p-value = 1.837e-11
mean(all_apo_starved$ordernorm_PAM_delta) #avg = 0.2984904
mean(all_sym_starved$ordernorm_PAM_delta, na.rm=TRUE) #had to tell it to ignore the one NA #avg =-0.2834233 #symbiotic colonies lost more photosynthetic efficiency

summary(all_sym_starved$ordernorm_PAM_delta)
...
t.test(A_10_20_F_A$ordernorm_PAM_delta, A_10_20_F_S$ordernorm_PAM_delta)
A_10_20_F_A$ordernorm_PAM_delta
```
...
sym_fed_ammonium_high_20C_melt<- melt(sym_fed_ammonium_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_ammonium_high_20C<-
 ...
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.7342"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium High - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_high_20C
#lets do a paired t test now
t.test(sym_fed_ammonium_high_20C$ordernorm_PAM_avg_day1,sym_fed_ammonium_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved ammonium high 20C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_high_20C_melt<- melt(sym_starved_ammonium_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_high_20C$ordernorm_PAM_avg_day1,sym_starved_ammonium_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_high_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.03821***"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_fed_ammonium_high_20C_melt<- melt(apo_fed_ammonium_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_high_20C$ordernorm_PAM_avg_day1,apo_fed_ammonium_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_high_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.3287"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_ammonium_high_20C_melt<- melt(apo_starved_ammonium_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_high_20C$ordernorm_PAM_avg_day1,apo_starved_ammonium_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_high_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.125"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_nitrate_high_20C_melt<- melt(sym_fed_nitrate_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_nitrate_high_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.5727"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate High - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_nitrate_high_20C
#lets do a paired t test now
t.test(sym_fed_nitrate_high_20C$ordernorm_PAM_avg_day1,sym_fed_nitrate_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved nitrate high 20C________________________ ###
#first we need to melt the dataset
sym_starved_nitrate_high_20C_melt<- melt(sym_starved_nitrate_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_high_20C$ordernorm_PAM_avg_day1,sym_starved_nitrate_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_high_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.9592 "), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate High - Sym Starved Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_high_20C

### ______________Apo fed nitrate high 20C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_high_20C_melt<- melt(apo_fed_nitrate_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_high_20C$ordernorm_PAM_avg_day1,apo_fed_nitrate_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_high_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, 0.3711"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_nitrate_high_20C_melt<- melt(apo_starved_nitrate_high_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_high_20C$ordernorm_PAM_avg_day1,apo_starved_nitrate_high_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_high_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.9485"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_control_20C_melt<- melt(sym_fed_control_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_control_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.2023"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Control High - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_control_20C
#lets do a paired t test now
t.test(sym_fed_control_20C$ordernorm_PAM_avg_day1,sym_fed_control_20C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved control high 20C________________________ ###
#first we need to melt the dataset
sym_starved_control_20C_melt<- melt(sym_starved_control_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_control_20C$ordernorm_PAM_avg_day1,sym_starved_control_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_control_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.05838*"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Control - Sym Starved Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_control_20C

### ______________Apo fed control high 20C________________________ ###
#first we need to melt the dataset
apo_fed_control_20C_melt<- melt(apo_fed_control_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_control_20C$ordernorm_PAM_avg_day1,apo_fed_control_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_control_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.07411"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_control_20C_melt<- melt(apo_starved_control_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_control_20C$ordernorm_PAM_avg_day1,apo_starved_control_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_control_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.03771***"), vjust = 1, hjust = 1, size=3)+
...
### _______________Sym fed ammonium high 20C_______________________ ###
#first we need to melt the dataset
sym_fed_ammonium_5um_20C_melt<- melt(sym_fed_ammonium_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_ammonium_5um_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1648"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium 5um - Sym Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_5um_20C
#lets do a paired t test now
t.test(sym_fed_ammonium_5um_20C$ordernorm_PAM_avg_day1,sym_fed_ammonium_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved ammonium high 20C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_5um_20C_melt<- melt(sym_starved_ammonium_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_5um_20C$ordernorm_PAM_avg_day1,sym_starved_ammonium_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_5um_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.166"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium 5um - Sym Starved Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_ammonium_5um_20C

### ______________Apo fed ammonium high 20C________________________ ###
#first we need to melt the dataset
apo_fed_ammonium_5um_20C_melt<- melt(apo_fed_ammonium_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_5um_20C$ordernorm_PAM_avg_day1,apo_fed_ammonium_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_5um_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.06953*"), vjust = 1, hjust = 1, size=3)+
...
### ______________Apo starved ammonium high 20C________________________ ###
#first we need to melt the dataset
apo_starved_ammonium_5um_20C_melt<- melt(apo_starved_ammonium_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_5um_20C$ordernorm_PAM_avg_day1,apo_starved_ammonium_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_5um_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.01202***"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_nitrate_5um_20C_melt<- melt(sym_fed_nitrate_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_nitrate_5um_20C$ordernorm_PAM_avg_day1,sym_fed_nitrate_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_nitrate_5um_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.8822"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_starved_nitrate_5um_20C_melt<- melt(sym_starved_nitrate_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_5um_20C$ordernorm_PAM_avg_day1,sym_starved_nitrate_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_5um_20C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1003 "), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 5um - Sym Starved Fed 20C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_5um_20C

### ______________Apo fed nitrate 5um 20C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_5um_20C_melt<- melt(apo_fed_nitrate_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_5um_20C$ordernorm_PAM_avg_day1,apo_fed_nitrate_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_5um_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.5904"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_nitrate_5um_20C_melt<- melt(apo_starved_nitrate_5um_20C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_5um_20C$ordernorm_PAM_avg_day1,apo_starved_nitrate_5um_20C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_5um_20C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.0596*"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_ammonium_high_30C_melt<- melt(sym_fed_ammonium_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_ammonium_high_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.101"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium High - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_high_30C
#lets do a paired t test now
t.test(sym_fed_ammonium_high_30C$ordernorm_PAM_avg_day1,sym_fed_ammonium_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved ammonium high 30C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_high_30C_melt<- melt(sym_starved_ammonium_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_high_30C$ordernorm_PAM_avg_day1,sym_starved_ammonium_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_high_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.7229"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium High - Sym Starved Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_ammonium_high_30C

### ______________Apo fed ammonium high 30C________________________ ###
#first we need to melt the dataset
apo_fed_ammonium_high_30C_melt<- melt(apo_fed_ammonium_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_high_30C$ordernorm_PAM_avg_day1,apo_fed_ammonium_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_high_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.5636"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_ammonium_high_30C_melt<- melt(apo_starved_ammonium_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_high_30C$ordernorm_PAM_avg_day1,apo_starved_ammonium_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_high_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1118"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_nitrate_high_30C_melt<- melt(sym_fed_nitrate_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_nitrate_high_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1218"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate High - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_nitrate_high_30C
#lets do a paired t test now
t.test(sym_fed_nitrate_high_30C$ordernorm_PAM_avg_day1,sym_fed_nitrate_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved nitrate high 30C________________________ ###
#first we need to melt the dataset
sym_starved_nitrate_high_30C_melt<- melt(sym_starved_nitrate_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_high_30C$ordernorm_PAM_avg_day1,sym_starved_nitrate_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_high_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.0244***"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate High - Sym Starved Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_high_30C

### ______________Apo fed nitrate high 30C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_high_30C_melt<- melt(apo_fed_nitrate_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_high_30C$ordernorm_PAM_avg_day1,apo_fed_nitrate_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_high_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.06184*"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_nitrate_high_30C_melt<- melt(apo_starved_nitrate_high_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_high_30C$ordernorm_PAM_avg_day1,apo_starved_nitrate_high_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_high_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.2323"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_control_30C_melt<- melt(sym_fed_control_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_control_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1699"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Control High - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_control_30C
#lets do a paired t test now
t.test(sym_fed_control_30C$ordernorm_PAM_avg_day1,sym_fed_control_30C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved control high 30C________________________ ###
#first we need to melt the dataset
sym_starved_control_30C_melt<- melt(sym_starved_control_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_control_30C$ordernorm_PAM_avg_day1,sym_starved_control_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_control_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.1929"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Control - Sym Starved Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_control_30C

### ______________Apo fed control high 30C________________________ ###
#first we need to melt the dataset
apo_fed_control_30C_melt<- melt(apo_fed_control_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_control_30C$ordernorm_PAM_avg_day1,apo_fed_control_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_control_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.2898"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_control_30C_melt<- melt(apo_starved_control_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_control_30C$ordernorm_PAM_avg_day1,apo_starved_control_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_control_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.00863***"), vjust = 1, hjust = 1, size=3)+
...
### _______________Sym fed ammonium high 30C_______________________ ###
#first we need to melt the dataset
sym_fed_ammonium_5um_30C_melt<- melt(sym_fed_ammonium_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#now we can plot
gg_sym_fed_ammonium_5um_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.805"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium 5um - Sym Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_fed_ammonium_5um_30C
#lets do a paired t test now
t.test(sym_fed_ammonium_5um_30C$ordernorm_PAM_avg_day1,sym_fed_ammonium_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)

### ______________Sym starved ammonium high 30C________________________ ###
#first we need to melt the dataset
sym_starved_ammonium_5um_30C_melt<- melt(sym_starved_ammonium_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_ammonium_5um_30C$ordernorm_PAM_avg_day1,sym_starved_ammonium_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_ammonium_5um_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.4104"), vjust = 1, hjust = 1, size=3)+
  ggtitle("Ammonium 5um - Sym Starved Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_ammonium_5um_30C

### ______________Apo fed ammonium high 30C________________________ ###
#first we need to melt the dataset
apo_fed_ammonium_5um_30C_melt<- melt(apo_fed_ammonium_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_ammonium_5um_30C$ordernorm_PAM_avg_day1,apo_fed_ammonium_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_ammonium_5um_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.3416"), vjust = 1, hjust = 1, size=3)+
...
### ______________Apo starved ammonium high 30C________________________ ###
#first we need to melt the dataset
apo_starved_ammonium_5um_30C_melt<- melt(apo_starved_ammonium_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_ammonium_5um_30C$ordernorm_PAM_avg_day1,apo_starved_ammonium_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_ammonium_5um_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, 0.1143"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_fed_nitrate_5um_30C_melt<- melt(sym_fed_nitrate_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_fed_nitrate_5um_30C$ordernorm_PAM_avg_day1,sym_fed_nitrate_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_fed_nitrate_5um_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.1112"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
sym_starved_nitrate_5um_30C_melt<- melt(sym_starved_nitrate_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(sym_starved_nitrate_5um_30C$ordernorm_PAM_avg_day1,sym_starved_nitrate_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_sym_starved_nitrate_5um_30C<-
  ...
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p= 0.02994*** "), vjust = 1, hjust = 1, size=3)+
  ggtitle("Nitrate 5um - Sym Starved Fed 30C: Day 1 vs. Day 11 Fv/Fm")
gg_sym_starved_nitrate_5um_30C

### ______________Apo fed nitrate 5um 30C________________________ ###
#first we need to melt the dataset
apo_fed_nitrate_5um_30C_melt<- melt(apo_fed_nitrate_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_fed_nitrate_5um_30C$ordernorm_PAM_avg_day1,apo_fed_nitrate_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_fed_nitrate_5um_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test,p= 0.184"), vjust = 1, hjust = 1, size=3)+
...
#first we need to melt the dataset
apo_starved_nitrate_5um_30C_melt<- melt(apo_starved_nitrate_5um_30C, id.vars="exp_1_beetag", measure.vars=c("ordernorm_PAM_avg_day1","ordernorm_PAM_avg_day11"))
#lets do a paired t test now
t.test(apo_starved_nitrate_5um_30C$ordernorm_PAM_avg_day1,apo_starved_nitrate_5um_30C$ordernorm_PAM_avg_day11, paired=TRUE)
#now we can plot
gg_apo_starved_nitrate_5um_30C<-
 ...
 theme(legend.position="none", plot.margin = unit(c(1,3, 0.5, 7),"cm"), plot.title = element_text(size = 9)) +
  #scale_color_manual(name = "Day of experiment",
                   ...
                   # values = c("royalblue","darkorchid1"))+
  scale_x_discrete(labels=c("Day 1","Day 11")) +
 annotate("text", x = Inf, y = Inf, label = paste("paired t-test, p=0.6714*"), vjust = 1, hjust = 1, size=3)+
...
pam_food_sym_state<- summarySE(pam_all.data, measurevar=c("ordernorm_PAM_delta"),groupvars =c("food_sym_state"), na.rm=TRUE)
pam_plot_food_sym_state <- ggplot(pam_food_sym_state, aes(x = food_sym_state, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
 ...
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
  ...
  geom_errorbar(aes(x = food_sym_state, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
...
sym_fed_ammonium_high_20C_SE<- summarySE(pam_all.data, measurevar=c("ordernorm_PAM_delta"),groupvars=c("treat_ID_collapsed_controls","food_sym_state","N_species","N_dose"), na.rm=TRUE)
plot_sym_fed_ammonium_high_20C_SE <- ggplot(sym_fed_ammonium_high_20C_SE, aes(x = treat_ID_collapsed_controls, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
  ...
  #geom_smooth(aes(group=food_sym_state), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
  geom_errorbar(aes(x = treat_ID_collapsed_controls, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
  #scale_color_manual(name = "Food and Symbiotic Status",
                     #labels = c("Fed Aposymbiotic","Fed Symbiotic","Starved Aposymbiotic", "Starved Symbiotic"),
                   # values = c("orchid1","darkorchid1","royalblue","skyblue"))+
 ylab("Change in Fv/Fm Pre vs. Post-experiment")+
...
all_cntrl_and_5um_20C_SE<- summarySE(all_cntrl_and_5um_20C, measurevar=c("ordernorm_PAM_delta"),groupvars=c("treat_ID_collapsed_controls","food_sym_state","N_species","N_dose"), na.rm=TRUE)
plot_all_cntrl_and_5um_20C_SE <- ggplot(all_cntrl_and_5um_20C_SE, aes(x = treat_ID_collapsed_controls, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
  theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1))+ #this makes the x axis labels up and down instead of side to side to prevent overlapping
  geom_point(size = 3, position = position_dodge(width=0.3))+
  #geom_smooth(aes(group=food_sym_state), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
...
all_cntrl_and_5um_30C_SE<- summarySE(all_cntrl_and_5um_30C, measurevar=c("ordernorm_PAM_delta"),groupvars=c("treat_ID_collapsed_controls","food_sym_state","N_species","N_dose"), na.rm=TRUE)
plot_all_cntrl_and_5um_30C_SE <- ggplot(all_cntrl_and_5um_30C_SE, aes(x = treat_ID_collapsed_controls, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
  theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1))+ #this makes the x axis labels up and down instead of side to side to prevent overlapping
  geom_point(size = 3, position = position_dodge(width=0.3))+
  #geom_smooth(aes(group=food_sym_state), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
...
all_cntrl_and_high_20C_SE<- summarySE(all_cntrl_and_high_20C, measurevar=c("ordernorm_PAM_delta"),groupvars=c("treat_ID_collapsed_controls","food_sym_state","N_species","N_dose"), na.rm=TRUE)
plot_all_cntrl_and_high_20C_SE <- ggplot(all_cntrl_and_high_20C_SE, aes(x = treat_ID_collapsed_controls, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
  theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1))+ #this makes the x axis labels up and down instead of side to side to prevent overlapping
  geom_point(size = 3, position = position_dodge(width=0.3))+
  #geom_smooth(aes(group=food_sym_state), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
...
all_cntrl_and_high_30C_SE<- summarySE(all_cntrl_and_high_30C, measurevar=c("ordernorm_PAM_delta"),groupvars=c("treat_ID_collapsed_controls","food_sym_state","N_species","N_dose"), na.rm=TRUE)
plot_all_cntrl_and_high_30C_SE <- ggplot(all_cntrl_and_high_30C_SE, aes(x = treat_ID_collapsed_controls, y= c(ordernorm_PAM_delta), color = food_sym_state))+
  theme_bw()+
  theme(axis.text.x = element_text(angle=90, vjust=.5, hjust=1))+ #this makes the x axis labels up and down instead of side to side to prevent overlapping
  geom_point(size = 3, position = position_dodge(width=0.3))+
  #geom_smooth(aes(group=food_sym_state), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
...
#ALL
pam_plot_treatment_all <- ggplot(pam_all.data, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
  geom_jitter(aes(), size=1.2, alpha=0.9)+
  geom_line(aes(group = treat_ID_without_sym), size = 0.5, linetype="dashed", position = position_dodge(width=0.3))+
  #geom_errorbar(aes(x = treat_ID_without_sym, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
  #scale_color_manual(name = "Treatment",
                     #labels = c("Control 30C Fed","Control 30C Starved","Ammonium High 30C Fed", "Ammonium High 30C Starved","test"),
                     #values = c("orchid1","darkorchid1","royalblue","skyblue","black","gray","brown"))+
 ylab("Change in Fv/Fm Pre vs. Post-experiment")+
...
pam_plot_treatment_SYM_all <- ggplot(sym_all, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
  geom_jitter(aes(), size=1.2, alpha=0.9)+
...
pam_plot_treatment_APO_all <- ggplot(apo_all, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
  geom_jitter(aes(), size=1.2, alpha=0.9)+
...
pam_treatmeans_apovsym <- summarySE(pam_all.data, measurevar=c("ordernorm_PAM_delta"),groupvars =c("sym_state.1"), na.rm=TRUE)


#AMMONIUM ONLY
# plot, treatment x axis colored by site data figure
pam_plot_apovsym <- ggplot(pam_treatmeans_apovsym, aes(x = sym_state.1, y= c(ordernorm_PAM_delta), color = sym_state.1))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
 ...
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
  ...
  geom_errorbar(aes(x = sym_state.1, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
  #scale_color_manual(name = "Treatment",
                    #labels = c("Control 30C Fed","Control 30C Starved","Ammonium High 30C Fed", "Ammonium High 30C Starved","test"),
                    # values = c("orchid1","darkorchid1","royalblue","skyblue","black","gray","brown"))+
 ylab("Change in Fv/Fm Pre vs. Post-experiment")+
...
pam_treatmeans_nitratevammonium <- summarySE(pam_all.data_simplified_controls, measurevar=c("ordernorm_PAM_delta"),groupvars =c("N_species"), na.rm=TRUE)

t.test(pam_all.data_simplified_controls$N_species=="N", pam_all.data_simplified_controls$N_species=="A")
# plot, treatment x axis colored by site data figure
pam_plot_nitratevammonium <- ggplot(pam_treatmeans_nitratevammonium, aes(x = N_species, y= c(ordernorm_PAM_delta), color = N_species))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
 ...
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
  ...
  geom_errorbar(aes(x = N_species, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
  #scale_color_manual(name = "Treatment",
                    #labels = c("Control 30C Fed","Control 30C Starved","Ammonium High 30C Fed", "Ammonium High 30C Starved","test"),
                    # values = c("orchid1","darkorchid1","royalblue","skyblue","black","gray","brown"))+
 ylab("Change in Fv/Fm Pre vs. Post-experiment")+
...
pam_treatmeans_20vs30 <- summarySE(pam_all.data_simplified_controls, measurevar=c("ordernorm_PAM_delta"),groupvars =c("temp.1"), na.rm=TRUE)

t.test(pam_all.data_simplified_controls$temp.1=="20", pam_all.data_simplified_controls$temp.1=="30")
# plot, treatment x axis colored by site data figure
pam_plot_20vs30 <- ggplot(pam_treatmeans_20vs30, aes(x = temp.1, y= c(ordernorm_PAM_delta), color = temp.1))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
 ...
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
  ...
  geom_errorbar(aes(x = temp.1, ymax = ordernorm_PAM_delta+se, ymin = ordernorm_PAM_delta-se), width = .2, position = position_dodge(width=0.3)) +
  #scale_color_manual(name = "Treatment",
                    #labels = c("Control 30C Fed","Control 30C Starved","Ammonium High 30C Fed", "Ammonium High 30C Starved","test"),
                    # values = c("orchid1","darkorchid1","royalblue","skyblue","black","gray","brown"))+
 ylab("Change in Fv/Fm Pre vs. Post-experiment")+
...
```{r All ammonium}
pam_treatmeans_ammonium <- summarySE(all_ammonium, measurevar=c("ordernorm_PAM_delta"),groupvars =c("treat_ID_without_sym"), na.rm=TRUE)

t.test(all_ammonium$N_dose==0, all_ammonium$N_dose==5)
# plot, treatment x axis colored by site data figure
pam_plot_ammonium <- ggplot(pam_treatmeans_ammonium, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
...
ammonium_jitter <- ggplot(all_ammonium, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
  geom_jitter(aes(), size=1.2, alpha=0.9)+
...
pam_treatmeans_nitrate <- summarySE(all_nitrate, measurevar=c("ordernorm_PAM_delta"),groupvars =c("treat_ID_without_sym"), na.rm=TRUE)

t.test(all_ammonium$N_dose==0, all_ammonium$N_dose==5)
# plot, treatment x axis colored by site data figure
pam_plot_nitrate<- ggplot(pam_treatmeans_nitrate, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
 # geom_jitter(aes(), size=1.2, alpha=0.9)+
...
nitrate_jitter <- ggplot(all_nitrate, aes(x = treat_ID_without_sym, y= c(ordernorm_PAM_delta), color = treat_ID_without_sym))+
  theme_bw()+
  geom_point(size = 3, position = position_dodge(width=0.3))+
  geom_smooth(aes(group=treat_ID_without_sym), position = position_dodge(width=0.3), size = 0.5, method='lm', se = FALSE)+
  geom_jitter(aes(), size=1.2, alpha=0.9)+
...
mm_null <- lmer(ordernorm_PAM_delta ~ 1 + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_null)
...
mm_1 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp + N_dose*food + N_dose*sym_state + temp*food + temp*sym_state + food*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_1)

#dropping food*sym_state
mm_2 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp + N_dose*food + N_dose*sym_state + temp*food + temp*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_2)

#dropping temp*sym_state
mm_3 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp + N_dose*food + N_dose*sym_state + temp*food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_3)

#dropping temp*food
mm_4 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp + N_dose*food + N_dose*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_4)

#dropping N_dose*sym_state
mm_5 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp + N_dose*food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_5)

#dropping N_dose*food
mm_6 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + N_dose*temp  + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_6)

#dropping N_dose*temp
mm_7 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + N_species*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_7)
#SIGNIFICANT FROM TEMP

#dropping N_species*sym_state
mm_8 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + N_species*food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_8)
#SIGNFICANT SYM STATE AND TEMP

#dropping N_species*food
mm_9 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose + N_species*temp + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_9)
#SIGNFICANT SYM STATE AND TEMP

#dropping N_species*temp
mm_10 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*N_dose  + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_10)

#dropping N_species*N_dose
mm_10_B <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state  + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_10_B)
...
#dropping sym_state
mm_11 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_11)

#dropping food
mm_12 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_12)

#dropping temp
mm_13 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_13)

#dropping N_dose
mm_14 <- lmer(ordernorm_PAM_delta~ N_species + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_14)
...
mm_15 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + sym_state  + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_15)

#sym state, food, and temp
mm_16 <- lmer(ordernorm_PAM_delta ~ food + temp + sym_state  + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_16)


#some interactions
mm_17 <- lmer(ordernorm_PAM_delta~ N_species + N_dose + temp + food + sym_state + temp*sym_state + N_species*temp + N_species*sym_state + N_dose*temp + food*temp + N_dose*sym_state + food*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_17)

mm_18 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*temp + N_species*sym_state + N_dose*temp + food*temp + N_dose*sym_state + food*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_18)

mm_19 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*temp + N_species*sym_state + N_dose*temp + food*temp + N_dose*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_19)


mm_20 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*temp + N_species*sym_state + food*temp + N_dose*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_20)

mm_21 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*temp + food*temp + N_dose*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_21)


mm_22 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp + food + sym_state + N_species*temp + N_dose*sym_state + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_22)

mm_23 <- lmer(ordernorm_PAM_delta~ N_species + N_dose + temp + food + sym_state + N_species*temp + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_23)

## AIC WINNER ## ## AIC WINNER ## ## AIC WINNER ## ## AIC WINNER ##
mm_24 <- lmer(ordernorm_PAM_delta ~ temp + sym_state + food + sym_state*temp + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_24)
#This is the AIC winner
#put the model into emmeans to do a post hoc
emm_24=emmeans(mm_24, specs=pairwise ~ food)
summary(emm_24)
...
#treatment explains 27.9% of variation
plot(mm_24)
...
mm_24_B <- lmer(ordernorm_PAM_delta ~ temp + sym_state + food + sym_state*temp + food*sym_state + food*temp+ (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_24_B)

mm_24_C <- lmer(ordernorm_PAM_delta ~ temp + sym_state + food + sym_state*food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_24_C)
...
mm_24_D <- lmer(ordernorm_PAM_delta ~ temp +  N_dose  + (1|jar_unique_ID) + (1|col_num), data= all_sym_fed)
summary(mm_24_D)
emm_24_D=emmeans(mm_24_D, specs=pairwise ~ temp)
summary(emm_24_D)

mm_24_E <- lmer(ordernorm_PAM_delta ~ temp +  N_dose + (1|jar_unique_ID) + (1|col_num), data= all_sym_starved)
summary(mm_24_E)
emm_24_E=emmeans(mm_24_E, specs=pairwise ~ temp)
summary(emm_24_E)

mm_24_F <- lmer(ordernorm_PAM_delta ~ temp +  N_dose  + (1|jar_unique_ID) + (1|col_num), data= all_apo_fed)
summary(mm_24_F)
emm_24_F=emmeans(mm_24_F, specs=pairwise ~ temp)
summary(emm_24_F)

mm_24_G <- lmer(ordernorm_PAM_delta ~ temp +  N_dose  + (1|jar_unique_ID) + (1|col_num), data= all_apo_starved)
summary(mm_24_G)
emm_24_G=emmeans(mm_24_G, specs=pairwise ~ N_dose)
summary(emm_24_G)

AIC(mm_24_G, mm_24_H)

#taking sym state out
mm_25 <- lmer(ordernorm_PAM_delta ~ N_species + N_dose + temp +food + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_25)

mm_26 <- lmer(ordernorm_PAM_delta~ temp + sym_state + food + temp*sym_state+ food*sym_state+ (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_26)
...
mm_27 <- lmer(ordernorm_PAM_delta~ sym_state + food + N_dose + food*sym_state+ (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_27)
emm_27=emmeans(mm_27, specs=pairwise ~ food)
summary(emm_27)

mm_28<-lmer(ordernorm_PAM_delta~ treat_ID_collapsed_controls + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_28)
emm_28=emmeans(mm_28, specs=pairwise ~ treat_ID_collapsed_controls)
summary(emm_28)

mm_29<-lmer(ordernorm_PAM_delta~ treat_ID_without_sym + (1|jar_unique_ID) + (1|col_num), data= pam_all.data)
summary(mm_29)
emm_29=emmeans(mm_29, specs=pairwise ~ treat_ID_without_sym)
summary(emm_29)


food_sym_state_aov<-aov(ordernorm_PAM_delta ~ food_sym_state, data=pam_all.data)
